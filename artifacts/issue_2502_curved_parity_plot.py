...
ax.scatter([1.347], [0.89834], color=AQUA, s=52, zorder=4, marker="D",
...
ax.set_title(
    "Curved atoms win at matched decoder parameters — under the steelman's own trainer\n"
