...
- Python test failures: **NOT MEASURED — at least 154** (LOWER BOUND, not a count: Python populations, slow + torch (job `cancelled`) did not run to completion, so the tests they never reached are unmeasured, not passing)
...
- `crates/gam-cli/src/main/run_survival.rs:938:13` — [E0063] missing field `logslope_template` in initializer of `gam::gam_models::survival::SurvivalMarginalSlopeTermSpec`
- `crates/gam-cli/src/../../../tests/src_modules/misc/cli_tests.rs:623:5` — [E0063] missing fields `logslope_time_degree` and `logslope_time_k` in initializer of `cli_args::FitArgs`
- `crates/gam-cli/src/../../../tests/src_modules/misc/cli_tests.rs:1338:13` — [E0063] missing fields `logslope_time_degree` and `logslope_time_k` in initializer of `cli_args::FitArgs`
- `crates/gam-cli/src/../../../tests/src_modules/misc/cli_tests.rs:1486:13` — [E0063] missing fields `logslope_time_degree` and `logslope_time_k` in initializer of `cli_args::FitArgs`
- `crates/gam-cli/src/../../../tests/src_modules/misc/cli_tests.rs:1599:13` — [E0063] missing fields `logslope_time_degree` and `logslope_time_k` in initializer of `cli_args::FitArgs`
- `crates/gam-cli/src/../../../tests/src_modules/misc/cli_tests.rs:1700:17` — [E0063] missing fields `logslope_time_degree` and `logslope_time_k` in initializer of `cli_args::FitArgs`
- `crates/gam-cli/src/../../../tests/src_modules/misc/cli_tests.rs:1856:13` — [E0063] missing fields `logslope_time_degree` and `logslope_time_k` in initializer of `cli_args::FitArgs`
- `crates/gam-cli/src/../../../tests/src_modules/misc/cli_tests.rs:2152:13` — [E0063] missing fields `logslope_time_degree` and `logslope_time_k` in initializer of `cli_args::FitArgs`
- `crates/gam-cli/src/../../../tests/src_modules/misc/cli_tests.rs:2277:23` — [E0063] missing fields `logslope_time_degree` and `logslope_time_k` in initializer of `cli_args::FitArgs`
- `crates/gam-cli/src/../../../tests/src_modules/misc/cli_tests.rs:2336:23` — [E0063] missing fields `logslope_time_degree` and `logslope_time_k` in initializer of `cli_args::FitArgs`
- `crates/gam-cli/src/../../../tests/src_modules/misc/cli_tests.rs:2814:20` — [E0063] missing fields `logslope_time_degree` and `logslope_time_k` in initializer of `cli_args::FitArgs`
- `crates/gam-cli/src/../../../tests/src_modules/misc/cli_tests.rs:2959:5` — [E0063] missing fields `logslope_time_degree` and `logslope_time_k` in initializer of `cli_args::FitArgs`
- `crates/gam-cli/src/../../../tests/src_modules/misc/cli_tests.rs:3120:20` — [E0063] missing fields `logslope_time_degree` and `logslope_time_k` in initializer of `cli_args::FitArgs`
- `crates/gam-cli/src/../../../tests/src_modules/misc/cli_tests.rs:5842:16` — [E0063] missing fields `logslope_time_degree` and `logslope_time_k` in initializer of `cli_args::SurvivalArgs`
- `crates/gam-cli/src/../../../tests/src_modules/misc/cli_tests.rs:5895:20` — [E0063] missing fields `logslope_time_degree` and `logslope_time_k` in initializer of `cli_args::SurvivalArgs`
- `crates/gam-cli/src/../../../tests/src_modules/misc/cli_tests.rs:7295:20` — [E0063] missing fields `logslope_time_degree` and `logslope_time_k` in initializer of `cli_args::SurvivalArgs`
- `crates/gam-cli/src/../../../tests/src_modules/misc/cli_tests.rs:7356:5` — [E0063] missing fields `logslope_time_degree` and `logslope_time_k` in initializer of `cli_args::SurvivalArgs`
- `crates/gam-cli/src/../../../tests/src_modules/misc/cli_tests.rs:7478:20` — [E0063] missing fields `logslope_time_degree` and `logslope_time_k` in initializer of `cli_args::SurvivalArgs`
- `crates/gam-cli/src/../../../tests/src_modules/misc/cli_tests.rs:7561:20` — [E0063] missing fields `logslope_time_degree` and `logslope_time_k` in initializer of `cli_args::SurvivalArgs`
- `crates/gam-cli/src/../../../tests/src_modules/misc/cli_tests.rs:7610:20` — [E0063] missing fields `logslope_time_degree` and `logslope_time_k` in initializer of `cli_args::SurvivalArgs`
- `crates/gam-cli/src/../../../tests/src_modules/misc/cli_tests.rs:7660:20` — [E0063] missing fields `logslope_time_degree` and `logslope_time_k` in initializer of `cli_args::SurvivalArgs`
- `crates/gam-cli/src/../../../tests/src_modules/misc/cli_tests.rs:7712:20` — [E0063] missing fields `logslope_time_degree` and `logslope_time_k` in initializer of `cli_args::SurvivalArgs`
- `crates/gam-cli/src/../../../tests/src_modules/misc/cli_tests.rs:8165:16` — [E0063] missing fields `logslope_time_degree` and `logslope_time_k` in initializer of `cli_args::SurvivalArgs`
- `crates/gam-cli/src/../../../tests/src_modules/misc/cli_tests.rs:8231:16` — [E0063] missing fields `logslope_time_degree` and `logslope_time_k` in initializer of `cli_args::SurvivalArgs`
- `crates/gam-cli/src/../../../tests/src_modules/misc/cli_tests.rs:8301:35` — [E0063] missing fields `logslope_time_degree` and `logslope_time_k` in initializer of `cli_args::SurvivalArgs`
- `crates/gam-cli/src/../../../tests/src_modules/misc/cli_tests.rs:8367:25` — [E0063] missing fields `logslope_time_degree` and `logslope_time_k` in initializer of `cli_args::SurvivalArgs`
- `?` — could not compile `gam-cli` (bin "gam" test) due to 26 previous errors
...
_Lower bound: 154 recorded before the run stopped. Unmeasured: Python populations, slow + torch (job `cancelled`)._
