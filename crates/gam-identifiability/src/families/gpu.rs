        ...
        pub(super) fn compute_grams_fused(&self, h_packed: &Array2<f64>) -> Option<GramBundle> {
            ...
            let module = FUSED_GRAM_PTX_CACHE
                .get_or_compile(
                    ...
                    crate::families::gpu_kernel::KERNEL_SRC,
                )
                .ok()?;
            let func = module
                .load_function(crate::families::gpu_kernel::KERNEL_NAME)
                .ok()?;
            ...
            for block_a in 0..num_blocks {
                ...
                for block_b in 0..num_blocks {
                    ...
                    let tile_a = crate::families::gpu_kernel::TILE_A;
                    let tile_b = crate::families::gpu_kernel::TILE_B;
