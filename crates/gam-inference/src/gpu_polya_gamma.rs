...
//! * It does **not** define a public production family. The CPU reference
...
// Consumed by the CUDA source assembly, which compiles on Linux alone.
#[cfg(target_os = "linux")]
...
mod tests {
    ...
    fn batch_dispatch_selects_every_declared_regime_at_its_boundaries() {
        let cases = [
            ...
            (SADDLE_MAX_B + 1, -0.5, PolyaGammaCpuRegime::NormalApproximation),
        ];
