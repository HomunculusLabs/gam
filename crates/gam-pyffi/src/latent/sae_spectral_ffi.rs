...
fn audit_sae<'py>(
    ...
    let report = detach_py_result(py, "audit_sae", move || {
        run_sparse_sae_audit(SparseSaeAuditRequest {
            ...
            config: SparseSaeAuditConfig {
                ...
                transport_layer_from,
                transport_layer_to,
                calibration: StandingCalibrationConfig {
                    null_replicates,
                    null_seed,
                    spikein_trials,
                    spikein_snr,
