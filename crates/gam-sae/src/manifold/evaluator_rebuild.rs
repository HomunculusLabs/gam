//! Atom resolution policy (issue #2236).
//!
//! Widths are derived only from constructor-validated
//! [`SaeAtomGeometryPlan`](super::SaeAtomGeometryPlan)s. There is intentionally no
//! evaluator reconstruction from realized widths.
