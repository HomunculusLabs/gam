...
fn run_from_decoder(
    ...
    for epoch in 0..config.max_epochs {
        ...
        let stats = if s == 1 {
            ...
            // MOD rows are the unconstrained optimum; the certified map refreshes
...
/// point of the unit-constrained problem the trainer certifies. The single-atom
/// lane already refreshes to its constrained optimum (`profiled_direction`).
///
