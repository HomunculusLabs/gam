...
// linear-algebra fixture; it lives in `gam-linalg-test-support`, the dev-only
...
pub use gam_linalg_test_support::no_densify_design;
...
// no model-layer type, so it lives in `gam-linalg-test-support`.
pub use gam_linalg_test_support::fd_checker;
pub use gam_linalg_test_support::fd_checker::{
