...
use gam::identifiability::canonical::canonicalize_for_identifiability_with_operating_scalars;
...
fn owed_1388_flat_underdetermined_joint_canonicalizes_min_target() {
    ...
    let canon = match canonicalize_for_identifiability_with_operating_scalars(
        &specs,
        &spanning_coordinates(&specs),
        None,
    ) {
