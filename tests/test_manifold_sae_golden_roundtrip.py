...
These fixtures are the exact v7 output of the Rust-owned
...
def test_golden_fixture_exists_and_is_schema_v7() -> None:
    payload = _load(GOLDEN_FULL)
    assert payload["schema"] == "gamfit.ManifoldSAE/v7"
